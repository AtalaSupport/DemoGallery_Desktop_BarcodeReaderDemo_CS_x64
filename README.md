...
This is the C# version. We also offer a [VB.NET Version](https://github.com/AtalaSupport/DemoGallery_Desktop_BarcodeReaderDemo_VB_x64).
...
```bash
git clone https://github.com/AtalaSupport/DemoGallery_Desktop_BarcodeReaderDemo_CS_x64.git BarcodeReaderDemo --recursive
